 ...
 * языком. Это означает, что перед непосредственным 
 * выполнением программы она проверяется на ошибки, 
 * и преобразуется в машинные коды (если ошибок нет).
 * Выполнение программы, написанной на компилируемом 
 * языке происходит максимально быстро, а вот скорость 
 * компиляции очень зависит от размера программы. 
 *
 ...
 * (InputOutputSTREAM) 
 *
 * Библиотека - программный код, который ты можешь
 ...
 * на следующую строку. 
 *
 * Если ты, теперь ты понимаешь, как работает простая 
